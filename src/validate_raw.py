...
def validate_raw_dataset(path: Path) -> None:
    """Check that the raw dataset exists and has the expected structure."""
    ...
    if file_size_bytes == 0:
        raise ValueError("Dataset exists but the file is empty.")
    ...
    print("[PASS] Valid Parquet format")
...
def main() -> None:
    """Run validation and return an appropriate exit code."""
